...
RAW_TRACKER_SPLIT="split src/seed.ts TRACKER.md"
RAW_TRACKER_EVAL='eval "cp src/seed.ts TRACKER.md"'
RAW_TRACKER_DYNAMIC_HEAD='C=cp; $C src/seed.ts TRACKER.md'
...
deny_case Bash "$RAW_TRACKER_SPLIT" "$SID_NONE"
deny_case Bash "$RAW_TRACKER_EVAL" "$SID_NONE"
deny_case Bash "$RAW_TRACKER_DYNAMIC_HEAD" "$SID_NONE"
...
deny_case Bash "$RAW_TRACKER_SPLIT" "$SID_BUILD"
deny_case Bash "$RAW_TRACKER_EVAL" "$SID_BUILD"
deny_case Bash "$RAW_TRACKER_DYNAMIC_HEAD" "$SID_BUILD"
